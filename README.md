...
FifthHomeWork:
Добавил класс ApplicationContext, в который перенес создание нужных мне в App объектов.
Далее в App создал объект класса ApplicationContext и через геттеры обращаюсь к объектам внутри контекста.
Добавил простое тестирование на ApplicationContext.
